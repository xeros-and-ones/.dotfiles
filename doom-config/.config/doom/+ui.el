...
(setq doom-font (font-spec :family "JetBrainsMono Nerd Font" :size 13 :weight 'semi-bold)
      ...
      doom-symbol-font (font-spec :family "FiraCode Nerd Font" :size 13 :weight 'bold)
      doom-big-font (font-spec :family "JetBrainsMono Nerd Font" :size 19))
;; (setq doom-font (font-spec :family "CaskaydiaCove Nerd Font" :size 13 :weight 'semibold)
